...
public class Preferences {
    ...
    public static final String KEY_OTA_LAST_UPDATE_DEVICE_ADDRESS = "ota_last_update_device_address";
	...
	public static final String KEY_MUSIC_PLIST_LENGTH = "music_plist_length";
	public static final String KEY_UHOST_PLIST_LENGTH = "uhost_plist_length";
	public static final String KEY_CRECORD_PLIST_LENGTH = "crecord_plist_length";
	public static final String KEY_URECORD_PLIST_LENGTH = "urecord_plist_length";
	...
	public static final String KEY_CONTENT_CHANGE_ID = "key_content_change_id";
	public static final String KEY_FETCHING_CONTENT_CHANGE_ID = "key_fetching_content_change_id";
	public static final String KEY_FETCHING_DEVICE_MAC_ADDRESS = "key_fetching_device_mac_address";


	public static final String KEY_SDCARD_MUSIC_FOLDER_LIST = "key_sdcard_music_folder_list";
	public static final String KEY_UHOST_MUSIC_FOLDER_LIST = "key_uhost_music_folder_list";
