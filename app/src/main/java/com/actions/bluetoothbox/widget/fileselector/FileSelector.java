...
/**
 * Created by chenxiangjie on 2015/11/26.
 */
...
public class FileSelector {
    ...
    private void initAll() {
        ...
        //View的初始化
        fileSelector = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.file_selector, null);
        fileListView = (ListView) fileSelector.findViewById(R.id.file_listView);
        title = (TextView) fileSelector.findViewById(R.id.file_title);
        cancelButton = (Button) fileSelector.findViewById(R.id.file_cancel_btn);
        confirmButton = (Button) fileSelector.findViewById(R.id.file_confirm_btn);
        hitBar = (LinearLayout) fileSelector.findViewById(R.id.file_hit_bar);
        unSelectButton = (ImageButton) hitBar.findViewById(R.id.file_hit_bar_icon);
        countText = (TextView) hitBar.findViewById(R.id.file_hit_bar_text);
        hitBar.setVisibility(View.GONE);
        optionBar = (LinearLayout) fileSelector.findViewById(R.id.file_bottom);


        LinearLayout listContainer = (LinearLayout) fileSelector.findViewById(R.id.list_container);
        ...
        initConfig();
        if (!new File(fileConfig.startPath).exists()) {
            fileConfig.startPath = FileUtils.getExternalStorageDir(context);
        }
    ...
    public void hitConfirmButton() {
        fileSelector.findViewById(R.id.file_confirm_btn).setVisibility(View.GONE);
    }

    public void showConfirmButton() {
        fileSelector.findViewById(R.id.file_confirm_btn).setVisibility(View.VISIBLE);
    }

    public void enableConfirmButton() {
        fileSelector.findViewById(R.id.file_confirm_btn).setEnabled(true);
    }

    public void unableConfirmButton() {
        fileSelector.findViewById(R.id.file_confirm_btn).setEnabled(false);
    }

    public void showBottomBar() {
        fileSelector.findViewById(R.id.file_bottom).setVisibility(View.VISIBLE);
    }

    public void hitBottomBar() {
        fileSelector.findViewById(R.id.file_bottom).setVisibility(View.GONE);
    }
